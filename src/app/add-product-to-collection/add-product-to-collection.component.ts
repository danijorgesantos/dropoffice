...
@Component({
  selector: 'app-add-product-to-collection',
  templateUrl: './add-product-to-collection.component.html',
  styleUrls: ['./add-product-to-collection.component.scss']
})
export class AddProductToCollectionComponent implements OnInit {
